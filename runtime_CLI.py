...
def get_parser():
    ...
    parser.add_argument('-c', '--command', help='Command to execute for table update',
                        type=str, action="append", default=[], required=False)
...
def main():
    ...
    if args.command != []:
        ...
        for cmd in args.command:
            RuntimeAPI(args.pre, standard_client, mc_client).onecmd(cmd)
    else:
